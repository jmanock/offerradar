...
]}><FeaturedPartnerOffers pagePath="/travel" affiliateIds={["hellosafe-travel-insurance", "hellosafe-card-insurance-checker", "esimshop"]} title="Useful travel research tools" /><div className="mt-12"><NetworkOpportunityModule sourcePage="/travel" /></div></DiscoveryHub>; }
