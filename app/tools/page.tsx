...
export default function ToolsPage() {
  return <main>
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <FeaturedPartnerOffers pagePath="/tools" affiliateIds={["hellosafe-travel-insurance", "hellosafe-card-insurance-checker", "esimshop"]} title="Travel research resources" placementId="travel-resource" />
      <FeaturedPartnerOffers pagePath="/tools" affiliateIds={["kitco"]} title="Market research resource" placementId="research-resource" />
    </div>
  </main>;
}
