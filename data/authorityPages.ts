...
export const authorityPages: AuthorityPage[] = [
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { href: "/bank-bonuses", label: "Checking and savings offers" },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Traditional banks", body: "Traditional banks may offer branches, cash handling, broader product sets, and relationship banking. Compare account package rules and fee waivers before relying on a promotion.", points: ["Branch access", "Relationship tiers", "Account packages", "Direct deposit rules"] },
      { title: "Credit unions", body: "Credit unions can offer local service or member-focused accounts, but membership eligibility, shared branching, mobile tools, and fee schedules vary by institution.", points: ["Membership eligibility", "Shared branching", "Checking fees", "Mobile banking"] },
      { title: "Direct deposit requirements", body: "Providers define qualifying direct deposit differently. Verify accepted sources, required amount, timing window, and whether a direct deposit is needed for a fee waiver or bonus.", points: ["Qualifying source", "Required amount", "Posting window", "Waiver rules"] },
      { title: "Mobile banking features", body: "Mobile deposit, alerts, card controls, external transfers, account locking, and support access can matter as much as a branch network for many checking users.", points: ["Mobile deposit", "Card controls", "Transfer limits", "Security alerts"] },
    ],
    faq: [
      { question: "What is the best bank for checking?", answer: "There is no single best bank for every user. Compare monthly fees, waiver rules, ATM and branch access, mobile tools, direct deposit compatibility, support, and current provider terms." },
      { question: "Are online banks good for checking?", answer: "Online banks can be a good fit for digital-first users, but verify cash deposit options, ATM access, support hours, transfer limits, and account eligibility." },
      { question: "Should I choose a checking account for the bonus?", answer: "A bonus can be one comparison factor, but the account's monthly fees, waiver rules, access, and ongoing usefulness may matter more over time." },
  ...
  {
    slug: "best-checking-and-savings-account-offers",
    title: "Best Checking and Savings Account Offers",
    description: "Compare checking and savings account offers by bonus type, direct deposit requirements, minimum deposits, monthly fees, and verification dates.",
    h1: "Best checking and savings account offers",
    intro: "Checking and savings account offers can use very different requirements. Checking promotions often involve direct deposit or account activity, while savings promotions may require new money, balance tiers, and maintained balances. Compare the account fit and verify current provider terms before opening an account.",
    sections: [
      { title: "Current account offers", body: "Use tracked records as a research starting point, then confirm current availability, eligibility, deadlines, and account terms directly with each provider.", points: ["Tracked record", "Current terms", "Eligibility", "Last verified"] },
      { title: "Checking bonuses", body: "Checking bonuses commonly depend on opening an eligible account, receiving qualifying direct deposits, using an offer code, or completing activity within a stated window.", points: ["Direct deposit", "Offer code", "Activity window", "Monthly fee"] },
      { title: "Savings bonuses", body: "Savings promotions may depend on new money, balance tiers, maintained balances, variable APY, and transfer limits. The stated bonus is not the whole comparison.", points: ["New money", "Balance tier", "Hold period", "Variable APY"] },
      { title: "Combined account offers", body: "Some institutions may package checking and savings features together. Compare whether the bundle adds useful features or simply adds requirements.", points: ["Account bundle", "Fee waiver", "Transfer access", "Ongoing fit"] },
      { title: "Minimum deposit requirements", body: "Opening deposit, bonus funding threshold, direct deposit amount, and maintained balance can all be different. Verify the exact requirement before moving money.", points: ["Opening deposit", "Funding threshold", "Maintained balance", "Deposit deadline"] },
      { title: "Direct deposit requirements", body: "A qualifying direct deposit may need to come from payroll, benefits, or another accepted source. Provider terms control what counts.", points: ["Accepted source", "Required total", "Posting date", "Payout timing"] },
    ],
    faq: [
      { question: "What are the best checking and savings account offers?", answer: "The best offers are the ones where the requirements are clear and the account remains useful after the promotion. Compare fees, access, eligibility, direct deposit or balance rules, and provider terms." },
      { question: "Should I compare checking and savings offers together?", answer: "Yes, if both account types fit your needs. Checking and savings promotions often use different requirements, so compare them separately before choosing." },
      { question: "Do savings account offers require new money?", answer: "Some do. Verify whether the provider requires new money, a maintained balance, a funding window, or a balance tier." },
      { question: "Can a checking bonus require direct deposit?", answer: "Many checking promotions do, but not all. Verify qualifying sources, amounts, deadlines, and exclusions directly with the provider." },
    ],
    relatedLinks: [
      { href: "/bank-bonuses", label: "Bank bonuses" },
      { href: "/best-banks-for-checking", label: "Best banks for checking" },
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      { href: "/best-banks-in-florida", label: "Banks in Florida" },
      { href: "/best-checking-accounts-florida", label: "Florida checking accounts" },
      { href: "/florida-bank-bonuses", label: "Florida offer tracker" },
    ],
  },
  {
  ...
  {
    slug: "2026-world-cup-banking-guide",
    title: "2026 World Cup Banking Guide",
    description: "Compare travel-friendly banking considerations for the 2026 World Cup, including foreign transaction fees, international ATM access, mobile banking, debit cards, and credit card terms.",
    h1: "2026 World Cup banking guide",
    intro: "International travel during the 2026 World Cup can make ordinary account details more important: debit-card access, foreign transaction fees, international ATM costs, mobile banking reliability, fraud settings, and backup payment methods. Use this guide as an educational checklist and verify current terms directly with your bank or card provider.",
    sections: [
      { title: "No foreign transaction fees", body: "A travel-friendly account or card may reduce foreign transaction costs, but fee schedules can change. Verify international purchase fees, debit fees, credit card fees, and currency conversion terms.", points: ["Foreign transaction fee", "Currency conversion", "Debit card terms", "Credit card terms"] },
      { title: "International ATM access", body: "ATM access abroad can involve bank fees, ATM-owner fees, exchange-rate handling, withdrawal limits, and fraud controls. Confirm the details before departure.", points: ["ATM network", "ATM-owner fees", "Withdrawal limits", "Exchange rate"] },
      { title: "Mobile banking while traveling", body: "Mobile access can help with alerts, transfers, card controls, support messages, and fraud response. Verify login methods and how you will receive authentication codes while traveling.", points: ["Secure login", "Card lock", "Alerts", "Support access"] },
      { title: "Travel-focused checking accounts", body: "A checking account for travel should be compared by debit access, ATM policy, minimum balances, monthly fees, customer support, and current provider terms.", points: ["Debit card abroad", "ATM policy", "Monthly fees", "Support hours"] },
      { title: "Debit cards abroad", body: "Debit cards can be useful for cash access but may expose your checking balance to holds, fraud issues, and ATM fees. Review limits, replacement options, and dispute procedures.", points: ["Cash access", "Fraud handling", "Daily limits", "Replacement card"] },
      { title: "Credit card considerations", body: "Credit cards may offer travel features, but approval, APR, annual fees, rewards, insurance, and benefits are controlled by provider terms. Do not rely on unverified benefit claims.", points: ["Approval terms", "Annual fee", "Rewards", "Benefit guide"] },
    ],
    faq: [
      { question: "What banking fees should I check before the 2026 World Cup?", answer: "Check foreign transaction fees, international ATM fees, ATM-owner fees, currency conversion terms, monthly fees, annual fees, and cash advance terms." },
      { question: "Should I use a debit card or credit card abroad?", answer: "Both can have roles. Debit cards are useful for cash access, while credit cards may offer purchase protections or rewards. Verify fees, limits, fraud policies, and provider terms." },
      { question: "How should I prepare mobile banking before international travel?", answer: "Confirm app access, authentication methods, card controls, alerts, support contacts, roaming or Wi-Fi access, and backup payment methods before leaving." },
      { question: "Does OfferRadar recommend a specific travel account?", answer: "No. OfferRadar provides educational comparison checklists. Verify account fit and terms directly with financial institutions." },
    ],
    relatedLinks: [
      ...
      { href: "/travel-fee-calculator", label: "Travel fee calculator" },
      { href: "/best-banks-for-checking", label: "Best banks for checking" },
      { href: "/credit-card-offers", label: "Credit card offer records" },
    ],
  },
  {
